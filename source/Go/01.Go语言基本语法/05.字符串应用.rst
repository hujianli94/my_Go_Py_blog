...
.. image:: ../../_static/go_format0001.png
...
参数说明如下。 - filename：INI 文件的文件名。 -
expectSection：期望读取的段。 - expectKey：期望读取段中的键。
...
行字符串linestr已经去除了空白字符串，段的起止符又以“[" 开头，以
"]”结尾，因此可以直接判断行首和行尾的字符串匹配段的起止符匹配时读取的是段，
