...
![](../../../_static/image-20220905111439111.png)
...
现在你可以启动你的网页浏览器，输入 [http://localhost:5000](http://localhost:5000/) 看看这个小应用程序的效果。
...
-  /todo/api/v1.0/tasks/<int:id>（获取单个任务）。
...
![](../../../_static/image-20220905175349613.png)
...
![](../../../_static/image-20220905175806809.png)
...
![](../../../_static/image-20220905180049136.png)
...
相反， **SQLAlchemy** ，Python工具包是一个强大的**OR Mapper**，它为应用程序开发人员提供了SQL的全部功能和灵活性。
