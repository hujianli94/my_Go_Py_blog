...
.. image:: ../../../_static/image-20220222115314779.png

-  传统网络请求模型

.. image:: ../../../_static/image-20220222115220040.png

-  前后端分离项目之后的网络传输流程。

.. image:: ../../../_static/image-20220222115353557.png
...
.. image:: ../../../_static/image-20220222115454457.png
...
（9）运行项目demo9，然后通过浏览器访问
http://127.0.0.1:9000/book/.获得了书籍列表的数据。

.. image:: ../../../_static/image-20220222145218082.png
...
在webpack的项目中，有config目录，该目录下有index.js文件，在这个文件内，进行简单的配置就可以解决跨域问题；而使用webpack-simple新建的项目，则没有这个目录，也没有这个文件。
   ...
   注意：
   虽然使用webpack新建的项目可以通过修改index.js文件中的一些配置代码轻松地解决跨域问题，而使用webpack-simple新建的项目没有这个文件，
...
..
   ...
   注意：
   ``<script>``\ 标签中的URL却是不同的，大家要注意不要与demo9_2混淆。
