...
在book\_project下的settings.py配置文件中，把默认的sqllite3数据库换成我们的mysql数据库
...
在项目setting文件同级\_\_init\_\_.py文件下加入
...
3.1.3 更改installed\_apps
'''''''''''''''''''''''''

将创建的app加入到installed\_apps里面
...
-  add\_book: 接受一个get请求，往数据库里添加一条book数据
...
把app下的urls添加到项目book\_project下的urls中，才能完成路由
...
.. figure:: ../../_static/postman0001.png
   :alt: 
...
在book\_project->settings文件夹下，修改如下内容，注意顺序
...
.. figure:: ../../_static/vue-admin0001.png
   :alt: 
...
/opt/inner\_ulb\_manager/static
即为静态文件目录，那么现在我们静态文件还在 frontend/dist
怎么办，不怕，Django给我们提供了命令：
